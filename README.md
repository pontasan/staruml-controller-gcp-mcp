...
4. The HTTP server starts — all GCP Architecture Diagram tools become available via MCP
...
```bash
claude mcp add staruml-gcp node /absolute/path/to/staruml-controller-gcp-mcp/dist/index.js
```
